...
public class Calculator : MonoBehaviour
{
    ...
    public void AddInput(string input)
    {
        ...
        AddInput(text.text); // may be right?
    ...
    public void Add()
    {
      ...
      float addition = prevInput + float.Parse(text.text);
        //      Set the text label to display that sum
        text.text += addition; //addition.ToString(); //may work
        clearPrevInput = true; //maybe not necessary
    }

    //TODO: Implement Subtract function
    public void Subtract()
    {
        float subtraction = prevInput + float.Parse(text.text);
    ...
    {
        float multiplication = prevInput + float.Parse(text.text);
    ...
    public void Divide()
    {
        float division = prevInput + float.Parse(text.text);
        text.text += division;
